...
Den data som används för den kvantitativa analysen är hämtad direkt från Karolinska och innehåller information om alla patienter som drabbats och vårdats för en eller flera hjärtinfarkter under kalenderåret 2013. Att den data som används kommer direkt från Karolinskas patientdatabas ger förutsättningar för en god reabilitet.
...
Designen av denna undersökning grundas i metoden CRISP-DM, en arbetsflödesmodell för projekt inom informationsutvinning, som är en av de vanligaste metoderna för denna typ av projekt (KDnuggets, 2007). Metoden består av sex faser:
